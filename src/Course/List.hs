...
-- lengthGT4 = snd . go (0, False)
--   where go _ Nil = (undefined, False)
--         go (4, _) (_ :. t) = (undefined, True)
--         go (a, f) (_ :. t) = go (a + 1, f) t
